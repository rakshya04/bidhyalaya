...
export default function Footer() {
  return (
    <footer className="bg-blue-100 text-black mt-10">
      ...
      {/* MAIN FOOTER */}
      <div className="max-w-7xl mx-auto px-20 py-12 grid grid-cols-3 md:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col items-start md:items-center">
          ...
          <ul className="space-y-2 text-black">
            ...
            <li><Link href="/live-classes" className="hover:text-blue-500">Live Classes</Link></li>
